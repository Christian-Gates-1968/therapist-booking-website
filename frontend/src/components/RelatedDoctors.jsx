...
>
        ...
        <button onClick={() =>{navigate('/doctors'); scrollTo(0, 0)}} className='bg-fuchsia-200 text-gray-800 px-12 py-3 rounded-full hover:scale-105 transition-all mt-10'>More</button>
    </div>
  )
}

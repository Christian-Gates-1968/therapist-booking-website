    ...
    <div className='m-5'>
      ...
      <div className='flex flex-wrap gap-3'>
        <div className='flex items-center gap-2 bg-white p-4 min-w-52 rounded border-2 border-fuchsia-100 cursor-pointer hover:scale-105 transition-all'>
          ...
          <div>
            <p className='text-xl font-semibold text-fuchsia-600'>{dashData.doctors}</p>
            <p className='text-fuchsia-400'>Doctors</p>
          </div>
        </div>
        <div className='flex items-center gap-2 bg-white p-4 min-w-52 rounded border-2 border-fuchsia-100 cursor-pointer hover:scale-105 transition-all'>
          ...
          {dashData.latestAppointments.slice(0, 10).map((item, index) => (
            <div className='flex items-center px-6 py-3 gap-3 hover:bg-fuchsia-100' key={index}>
              ...
              <div className='flex-1 text-sm'>
                <p className='text-fuchsia-800 font-medium'>{item.docData.name}</p>

...
const VideoRoom = () => {
    ...
    // Redirect if not authenticated or no profile data
    useEffect(() => {
        if (!dToken) {
            navigate('/login')
        }
            ...
            {localStream && !isLocalVideoMinimized && (
                <div className="absolute top-4 right-4 w-64 h-48 bg-black rounded-xl overflow-hidden shadow-2xl border-2 border-white/30 z-30 transition-all">
                    ...
                    <div className="absolute bottom-2 left-2 bg-black/60 text-white text-xs px-2 py-1 rounded">
                        You (Dr. {profileData?.name?.split(' ')[1] || 'Doctor'})
                    </div>
                </div>
            )}
            ...
            {showEndCallConfirm && (
                <div className="absolute inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center z-50">
                    <div className="bg-white rounded-2xl p-8 max-w-md mx-4 shadow-2xl">
                        ...
                        <p className="text-gray-600 mb-6">Are you sure you want to end this video consultation with the patient?</p>
            ...
            {callEndedByOther && (
                <div className="absolute inset-0 bg-black/80 backdrop-blur-sm flex items-center justify-center z-50">
                    <div className="bg-white rounded-2xl p-8 max-w-md mx-4 shadow-2xl text-center">
                        ...
                        <p className="text-gray-600 mb-4">The patient has ended the consultation.</p>
